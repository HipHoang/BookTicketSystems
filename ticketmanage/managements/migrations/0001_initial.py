# Generated by Django 5.1.2 on 2025-08-29 16:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', cloudinary.models.CloudinaryField(blank=True, default='', max_length=255, null=True, verbose_name='company_image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', cloudinary.models.CloudinaryField(blank=True, default='', max_length=255, null=True, verbose_name='bus_image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dropoff_only', models.BooleanField(default=False)),
                ('schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedule_stops', to='managements.schedule')),
                ('stop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedule_stops', to='managements.stop')),
            ],
            options={
                'ordering': ['-id'],
                'abstract': False,
